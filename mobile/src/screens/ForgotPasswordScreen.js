...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: "bold", color: "#b45309", textAlign: "center", marginBottom: 24 },
  ...
  button: { backgroundColor: "#d97706", borderRadius: 6, padding: 14, alignItems: "center", marginTop: 20 },
